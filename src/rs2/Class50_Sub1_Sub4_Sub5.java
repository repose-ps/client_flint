...
public class Class50_Sub1_Sub4_Sub5 extends Class50_Sub1_Sub4 {
	...
	public Class50_Sub1_Sub4_Sub5(int i, int j, int k, int l, int i1, byte byte0, int j1, boolean flag, int k1,
			int l1) {
		aBoolean1714 = false;
		anInt1720 = j1;
		anInt1721 = i1;
	...
	public Class50_Sub1_Sub4_Sub4 method561(byte byte0) {
		...
		if (class47 == null) {
			...
			Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4 = class47.method431(anInt1721, anInt1722, anInt1715,
