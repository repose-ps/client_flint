 ...
 *
 * <p>Instanced terrain and landscape data are stored in local chunk
 * coordinates. These helpers rotate those coordinates into their destination
 * chunk without allocating temporary coordinate objects.</p>
 */
public final class TiledUtils {
     ...
     *
     * <p>Odd object orientations exchange the object's width and height before
     * the chunk rotation is applied. This preserves the occupied south-west
     * corner rather than merely rotating a single point.</p>
     */
    public static int getRotatedLandscapeChunkX(int x, int y, int sizeX, int sizeY,
                                                 int objectOrientation, int chunkRotation) {
     ...
     */
    public static int getRotatedLandscapeChunkY(int x, int y, int sizeX, int sizeY,
                                                 int objectOrientation, int chunkRotation) {
        if ((objectOrientation & 1) == 1) {
            int originalSizeX = sizeX;
            sizeX = sizeY;
