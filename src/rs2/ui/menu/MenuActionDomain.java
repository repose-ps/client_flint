...
/**
 * Cohesive application domains used to route normalized revision-377 menu
 * actions.
 *
 * <p>
 * This is intentionally a small routing taxonomy rather than an action-type
 * hierarchy. Numeric action IDs remain authoritative in {@link MenuState}; the
 * domain only records which existing application handler owns each action.
 * </p>
 */
