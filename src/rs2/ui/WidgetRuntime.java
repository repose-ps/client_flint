...
public final class WidgetRuntime {
    ...
    /*
     * Legacy client.method88(int i, int j):
     *   i -> deltaCycles
     *   j -> interfaceId
     */
        ...
        for (int index = 0; index < parent.children.length; index++) {
            ...
            if (child.type == Widget.TYPE_MODEL && (child.animationId != -1 || child.activeAnimationId != -1)) {
                ...
                if (animationId != -1) {
                    ...
                    for (child.animationCycle += deltaCycles;
    ...
    /*
     * Legacy client.method112(byte byte0, int i):
     *   byte0 -> removed required 36 sentinel
     *   i -> interfaceId
     *
     * The legacy recursion checks type 1 rather than container type 0. That
     * oddity is deliberately preserved.
     */
    ...
    /*
     * Legacy client.method129(int i, int j, Widget class13):
     *   i -> removed required value 3 sentinel
     *   j -> scriptIndex
     *   class13 -> widget
     */
