...
public final class ClientScriptContext implements WidgetRuntime.ScriptContext {
    ...
    @Override public int currentSkillLevel(int skill) { return currentSkillLevel.applyAsInt(skill); }
    @Override public int baseSkillLevel(int skill) { return baseSkillLevel.applyAsInt(skill); }
    @Override public int skillExperience(int skill) { return skillExperience.applyAsInt(skill); }
    @Override public int varp(int id) { return varp.applyAsInt(id); }
    @Override public int experienceForLevel(int levelIndex) { return experienceForLevel.applyAsInt(levelIndex); }
    @Override public int bitMask(int width) { return bitMask.applyAsInt(width); }
    @Override public int runEnergy() { return runEnergy.getAsInt(); }
    @Override public int weight() { return weight.getAsInt(); }
    @Override public int combatLevel() { return combatLevel.getAsInt(); }
    @Override public int playerWorldX() { return playerWorldX.getAsInt(); }
    @Override public int playerWorldY() { return playerWorldY.getAsInt(); }
    @Override public boolean membersWorld() { return membersWorld.getAsBoolean(); }
}
