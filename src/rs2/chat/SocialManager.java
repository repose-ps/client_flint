 ...
 *
 * <p>This intentionally keeps the original fixed capacities and friend sorting
 * rules. It does not own widgets, chatbox rendering, menus, or login UI.</p>
 */
public final class SocialManager {
    ...
    public boolean addFriend(long encodedName, boolean membersAccount, String localPlayerName,
            Buffer outgoing, MessageSink messages) {
        if (encodedName == 0L) {
            return false;
        }
