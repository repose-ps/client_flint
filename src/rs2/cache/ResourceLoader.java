 ...
 *
 * <p>The retry timing and JAGGRAB framing deliberately remain source-accurate.
 * In particular, the supplied client returns a disk-cached archive immediately
...
public final class ResourceLoader {
     ...
     *
     * Parameter mapping:
     *   i  -> removed fixed 14076 sentinel
     *   j  -> expectedCrc
     *   s  -> archiveName
     *   k  -> loadingPercent
     *   l  -> cacheFileId
     ...
     *
     * <p>This method remains available for source correspondence, but the supplied
     * post-refactor startup path intentionally does not call it.</p>
     */
