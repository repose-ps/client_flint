...
public class Class50_Sub1_Sub4_Sub4 extends Renderable {
	...
	public Class50_Sub1_Sub4_Sub4(boolean flag, boolean flag1, boolean flag2,
			Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4, boolean flag3) {
		anInt1636 = 932;
		anInt1637 = 426;
		aBoolean1638 = false;
		aBoolean1639 = true;
		...
		for (int k = 0; k < anInt1652; k++)
			if (anIntArray1659 == null || anIntArray1659[k] != -1) {
				...
				if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
					...
					if (flag1 && method602(anInt1706, anInt1707, anIntArray1687[l], anIntArray1687[k1],
	...
	public void method600(int i) {
		...
		if (i1 == 0) {
			Class50_Sub1_Sub1_Sub4.method503(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j],
					anIntArray1686[k], anIntArray1686[l], anIntArray1656[i], anIntArray1657[i], anIntArray1658[i]);
			return;
		}
		if (i1 == 1) {
			Class50_Sub1_Sub1_Sub4.method505(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j],
					anIntArray1686[k], anIntArray1686[l], anIntArray1712[anIntArray1656[i]]);
			return;
		}
		if (i1 == 2) {
			...
			Class50_Sub1_Sub1_Sub4.method507(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j],
					anIntArray1686[k], anIntArray1686[l], anIntArray1656[i], anIntArray1657[i], anIntArray1658[i],
					anIntArray1689[l1], anIntArray1689[j2], anIntArray1689[l2], anIntArray1690[l1], anIntArray1690[j2],
					anIntArray1690[l2], anIntArray1691[l1], anIntArray1691[j2], anIntArray1691[l2], anIntArray1662[i]);
			return;
		}
		if (i1 == 3) {
			...
			Class50_Sub1_Sub1_Sub4.method507(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j],
					anIntArray1686[k], anIntArray1686[l], anIntArray1656[i], anIntArray1656[i], anIntArray1656[i],
					anIntArray1689[i2], anIntArray1689[k2], anIntArray1689[i3], anIntArray1690[i2], anIntArray1690[k2],
					anIntArray1690[i3], anIntArray1691[i2], anIntArray1691[k2], anIntArray1691[i3], anIntArray1662[i]);
		}
	}
	...
	public void method601(int i) {
		...
		if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
			...
			if (l == 3) {
				...
				if (l7 == 0)
					Class50_Sub1_Sub1_Sub4.method503(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1],
							anIntArray1701[2]);
				else if (l7 == 1)
					...
					Class50_Sub1_Sub1_Sub4.method507(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1],
							...
							anIntArray1691[k10], anIntArray1691[k11], anIntArray1662[i]);
				} else if (l7 == 3) {
					int k8 = anIntArray1659[i] >> 2;
					int l9 = anIntArray1665[k8];
					int l10 = anIntArray1666[k8];
					int l11 = anIntArray1667[k8];
					Class50_Sub1_Sub1_Sub4.method507(i7, j7, k7, j3, j4, j5, anIntArray1656[i], anIntArray1656[i],
							...
							anIntArray1691[l10], anIntArray1691[l11], anIntArray1662[i]);
				}
			}
			if (l == 4) {
				if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > Rasterizer.viewportRx || j4 > Rasterizer.viewportRx
				...
				if (i8 == 0) {
					Class50_Sub1_Sub1_Sub4.method503(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1],
							anIntArray1701[2]);
					Class50_Sub1_Sub1_Sub4.method503(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3],
				...
				if (i8 == 2) {
					...
					Class50_Sub1_Sub1_Sub4.method507(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1],
							...
							anIntArray1691[i11], anIntArray1691[i12], anIntArray1662[i]);
					Class50_Sub1_Sub1_Sub4.method507(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3],
				...
				if (i8 == 3) {
					...
					Class50_Sub1_Sub1_Sub4.method507(i7, j7, k7, j3, j4, j5, anIntArray1656[i], anIntArray1656[i],
							...
							anIntArray1691[j11], anIntArray1691[j12], anIntArray1662[i]);
					Class50_Sub1_Sub1_Sub4.method507(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3],
