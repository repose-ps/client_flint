 ...
 *
 * <p>
 * Each vector starts from the same zero-seed ISAAC state so the encrypted
 * opcode byte as well as every transformed payload field is frozen.
 * </p>
 */
public final class ActionPacketSelfTest {
	...
	static int run() {
		...
		vector(test, "use item on player", packets -> packets.useItemOnPlayer(0x1234, 0x2345, 0x3456, 0x4567),
				"824523d634456712b4");
		...
		vector(test, "use item on npc", packets -> packets.useItemOnNpc(0x1234, 0x2345, 0x3456, 0x4567),
				"2c12344523d6344567");
		...
		vector(test, "use item on object",
				packets -> packets.useItemOnObject(0x1234, 0x2345, 0x3456, 0x4567, 0x5678, 0x6789),
				"8b341245235634674556780967");
		vector(test, "cast spell on object", packets -> packets.castSpellOnObject(0x1234, 0x2345, 0x3456, 0x4567),
				"c51234452334d66745");
		...
		vector(test, "ground item option1", packets -> packets.groundItemOption1(0x1234, 0x2345, 0x3456),
				"4023c53456b412");
		vector(test, "ground item option2", packets -> packets.groundItemOption2(0x1234, 0x2345, 0x3456),
				"57234534d6b412");
		vector(test, "ground item option3", packets -> packets.groundItemOption3(0x1234, 0x2345, 0x3456),
				"3ab412c52334d6");
		vector(test, "ground item option4", packets -> packets.groundItemOption4(0x1234, 0x2345, 0x3456),
				"2912b456342345");
		vector(test, "ground item option5", packets -> packets.groundItemOption5(0x1234, 0x2345, 0x3456),
				"d9341223c53456");
		vector(test, "use item on ground item",
				packets -> packets.useItemOnGroundItem(0x1234, 0x2345, 0x3456, 0x4567, 0x5678, 0x6789),
				"c6e74556f8d634c52389673412");
		vector(test, "cast spell on ground item",
				packets -> packets.castSpellOnGroundItem(0x1234, 0x2345, 0x3456, 0x4567), "46341234566745c523");
		...
		vector(test, "inventory item option1", packets -> packets.inventoryItemOption1(0x1234, 0x2345, 0x3456),
				"be34d645233412");
		vector(test, "inventory item option2", packets -> packets.inventoryItemOption2(0x1234, 0x2345, 0x3456),
				"0b5634341223c5");
		vector(test, "inventory item option3", packets -> packets.inventoryItemOption3(0x1234, 0x2345, 0x3456),
				"94c523b4125634");
		vector(test, "inventory item option4", packets -> packets.inventoryItemOption4(0x1234, 0x2345, 0x3456),
				"d7452312b43456");
		vector(test, "inventory item option5", packets -> packets.inventoryItemOption5(0x1234, 0x2345, 0x3456),
				"f74523b412d634");
		vector(test, "widget item option1", packets -> packets.widgetItemOption1(0x1234, 0x2345, 0x3456),
				"f612b434562345");
		vector(test, "widget item option2", packets -> packets.widgetItemOption2(0x1234, 0x2345, 0x3456),
				"a423c534125634");
		vector(test, "widget item option3", packets -> packets.widgetItemOption3(0x1234, 0x2345, 0x3456),
				"4e3412c5233456");
		vector(test, "widget item option4", packets -> packets.widgetItemOption4(0x1234, 0x2345, 0x3456),
				"dad63445231234");
		vector(test, "widget item option5", packets -> packets.widgetItemOption5(0x1234, 0x2345, 0x3456),
				"91c523b4125634");
		vector(test, "use item on inventory item",
				packets -> packets.useItemOnInventoryItem(0x1234, 0x2345, 0x3456, 0x4567, 0x5678, 0x6789),
				"f4123445235634e74556f86709");
		vector(test, "cast spell on inventory item",
				packets -> packets.castSpellOnInventoryItem(0x1234, 0x2345, 0x3456, 0x4567), "17123423c534d645e7");
		...
		vector(test, "report abuse", packets -> packets.reportAbuse(0x0102030405060708L, 0x2345, true),
				"ab01020304050607084501");
