...
public class Class50_Sub1_Sub4_Sub3_Sub2 extends Class50_Sub1_Sub4_Sub3 {
	...
	public Class50_Sub1_Sub4_Sub4 method571(byte byte0) {
		...
		if (super.anInt1624 >= 0 && super.anInt1627 == 0) {
			...
			if (class14.shieldOverride >= 0) {
				i1 = class14.shieldOverride;
				l += i1 - anIntArray1752[5] << 40;
			}
			if (class14.weaponOverride >= 0) {
				j1 = class14.weaponOverride;
	...
	public void method572(Buffer class50_sub1_sub2, int i) {
		...
		if (super.anInt1629 == 65535)
			super.anInt1629 = -1;
		aString1751 = TextFormatter.formatDisplayName(Base37.decode(class50_sub1_sub2.readLong()));
