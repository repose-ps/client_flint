 ...
 *
 * <p>This code is intentionally stateful because the original client temporarily
 * replaces the global 2D raster and 3D projection bounds while drawing each icon.
 * The exact outline, shadow, note-overlay, cache-key, and sprite metadata quirks
 * are preserved.</p>
 */
public final class ItemSpriteFactory {
     ...
     * @param outlineColor {@code 0} for the normal diagonal shadow, {@code >0}
     *        for a colored outline, and {@code -1} for the enlarged note-overlay path
     */
    public static ImageRGB getSprite(int itemId, int quantity, int outlineColor) {
        ...
        model.renderSimple(0, definition.yan2d, definition.zan2d, definition.xan2d, definition.offsetX2d,
                sineOffset + model.modelHeight / 2 + definition.offsetY2d,
                cosineOffset + definition.offsetY2d);
    ...
    /** Used by the full item-definition teardown to preserve the original nulling behavior. */
