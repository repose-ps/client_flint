...
public class Class8 {
	...
	public static void method165(int i, int i_15_, int i_16_, int i_17_, CollisionMap class46, int i_18_, int i_19_,
			int i_20_, int i_21_, Class22 class22, int[][][] is) {
			...
			if (i_41_ > 0) {
				for (int i_44_ = 1; i_44_ < 8; i_44_++)
					anIntArrayArrayArray149[i_39_][i_41_][i_40_
							+ i_44_] = anIntArrayArrayArray149[i_39_][i_41_ - 1][i_40_ + i_44_];
			}
			if (i_40_ > 0) {
		...
		for (int i_50_ = 0; i_50_ < 4; i_50_++) {
			...
			for (int i_58_ = 1; i_58_ < anInt152 - 1; i_58_++) {
				for (int i_59_ = 1; i_59_ < anInt151 - 1; i_59_++) {
					int i_60_ = (anIntArrayArrayArray149[i_50_][i_59_ + 1][i_58_]
							- anIntArrayArrayArray149[i_50_][i_59_ - 1][i_58_]);
					int i_61_ = (anIntArrayArrayArray149[i_50_][i_59_][i_58_ + 1]
					...
					int i_67_ = ((is[i_59_ - 1][i_58_] >> 2) + (is[i_59_ + 1][i_58_] >> 3) + (is[i_59_][i_58_ - 1] >> 2)
				...
				if (i_69_ >= 1 && i_69_ < anInt151 - 1) {
					...
					for (int i_80_ = -5; i_80_ < anInt152 + 5; i_80_++) {
						...
						if (i_80_ >= 1 && i_80_ < anInt152 - 1
								&& (!aBoolean169 || (aByteArrayArrayArray138[0][i_69_][i_80_] & 0x2) != 0
										|| ((aByteArrayArrayArray138[i_50_][i_69_][i_80_] & 0x10) == 0
												&& (method164(i_80_, i_50_, i_69_, (byte) 0) == anInt162)))) {
							if (i_50_ < anInt150)
								anInt150 = i_50_;
							...
							if (i_83_ > 0 || i_84_ > 0) {
								...
								if (i_50_ > 0) {
									...
									if (i_83_ == 0 && (aByteArrayArrayArray153[i_50_][i_69_][i_80_]) != 0)
										bool = false;
									if (i_84_ > 0 && !(FloorDefinition.definitions[i_84_ - 1].occlude))
										bool = false;
								...
								if (i_84_ == 0)
									...
									FloorDefinition class15 = FloorDefinition.definitions[i_84_ - 1];
									...
									class22.method246(i_50_, i_69_, i_80_, i_99_, i_100_, i_101_, i_85_, i_86_, i_87_,
											i_88_, method171(i_93_, i_89_), method171(i_93_, i_90_),
											method171(i_93_, i_91_), method171(i_93_, i_92_), method182(i_102_, i_89_),
					...
					for (int i_114_ = 0; i_114_ <= anInt151; i_114_++) {
						if ((anIntArrayArrayArray168[i_112_][i_114_][i_113_] & i_108_) != 0) {
							...
							if (i_121_ >= 8) {
								...
								Class22.method244(-8967, i_114_ * 128, i_124_, i_114_ * 128, i_116_ * 128 + 128, i_111_,
										i_115_ * 128, i_123_, 1);
						...
						if ((anIntArrayArrayArray168[i_112_][i_114_][i_113_] & i_109_) != 0) {
							...
							if (i_133_ >= 8) {
								...
								Class22.method244(-8967, i_127_ * 128, i_136_, i_128_ * 128 + 128, i_113_ * 128, i_111_,
										i_113_ * 128, i_135_, 2);
						...
						if ((anIntArrayArrayArray168[i_112_][i_114_][i_113_] & i_110_) != 0) {
							...
							if ((i_140_ - i_139_ + 1) * (i_142_ - i_141_ + 1) >= 4) {
								...
								Class22.method244(-8967, i_139_ * 128, i_145_, i_140_ * 128 + 128, i_142_ * 128 + 128,
		...
		for (int i_154_ = 0; i_154_ < 8; i_154_++) {
			for (int i_155_ = 0; i_155_ < 8; i_155_++) {
				if (i_151_ + i_154_ > 0 && i_151_ + i_154_ < 103 && i_152_ + i_155_ > 0 && i_152_ + i_155_ < 103)
					class46s[i_149_].flags[i_151_ + i_154_][(i_152_ + i_155_)] &= ~0x1000000;
			}
		}
				...
				for (int i_158_ = 0; i_158_ < 64; i_158_++) {
					if (i_156_ == i_150_ && i_157_ >= i_153_ && i_157_ < i_153_ + 8 && i_158_ >= i_148_
						...
						method183(0, (byte) -61, 0, class50_sub1_sub2, i,
								i_151_ + TiledUtils.getRotatedMapChunkX(i_157_ & 0x7, i_158_ & 0x7, i), i_149_,
								i_152_ + TiledUtils.getRotatedMapChunkY(i_157_ & 0x7, i_158_ & 0x7, i));
					else
	...
	public void method172(int i, CollisionMap[] class46s, Class22 class22, boolean bool, byte[] is, int i_166_,
			...
			for (;;) {
				...
				for (;;) {
					...
					if (i_178_ == i_171_ && i_177_ >= i_168_ && i_177_ < i_168_ + 8 && i_176_ >= i_170_
						...
						int i_182_ = (i_169_ + TiledUtils.getRotatedLandscapeChunkX(i_177_ & 0x7, i_176_ & 0x7,
								class47.anInt801, class47.anInt775, i_181_, i_167_));
						int i_183_ = (i_166_ + TiledUtils.getRotatedLandscapeChunkY(i_177_ & 0x7, i_176_ & 0x7,
								class47.anInt801, class47.anInt775, i_181_, i_167_));
	...
	public void method173(Class22 class22, CollisionMap class46, int i, int i_185_, int i_186_, byte i_187_, int i_188_,
			...
			for (int i_215_ = 0; i_215_ < 64; i_215_++) {
				for (int i_216_ = 0; i_216_ < 64; i_216_++) {
					if (i_212_ + i_215_ > 0 && i_212_ + i_215_ < 103 && i + i_216_ > 0 && i + i_216_ < 103)
						class46s[i_214_].flags[i_212_ + i_215_][i + i_216_] &= ~0x1000000;
				}
			}
		}
		Buffer class50_sub1_sub2 = new Buffer(is);
	...
	public static int method178(int i, int i_233_) {
		int i_234_ = (method175(i - 1, i_233_ - 1) + method175(i + 1, i_233_ - 1) + method175(i - 1, i_233_ + 1)
				+ method175(i + 1, i_233_ + 1));
		int i_235_ = (method175(i - 1, i_233_) + method175(i + 1, i_233_) + method175(i, i_233_ - 1)
				+ method175(i, i_233_ + 1));
		int i_236_ = method175(i, i_233_);
		return i_234_ / 16 + i_235_ / 8 + i_236_ / 4;
	}

	public void method179(int i, CollisionMap[] class46s, int i_237_, int i_238_, Class22 class22, byte[] is) {
		if (i_238_ < 0) {
			Buffer class50_sub1_sub2 = new Buffer(is);
			int i_239_ = -1;
			for (;;) {
	...
	public void method183(int i, byte i_272_, int i_273_, Buffer class50_sub1_sub2, int i_274_, int i_275_, int i_276_,
		...
		if (i_275_ >= 0 && i_275_ < 104 && i_277_ >= 0 && i_277_ < 104) {
			...
			for (;;) {
				...
				if (i_278_ == 0) {
					if (i_276_ == 0)
						anIntArrayArrayArray149[0][i_275_][i_277_] = -method184(932731 + i_275_ + i,
								556238 + i_277_ + i_273_) * 8;
					else {
						anIntArrayArrayArray149[i_276_][i_275_][i_277_] = (anIntArrayArrayArray149[i_276_
								- 1][i_275_][i_277_] - 240);
						break;
					}
					break;
				...
				if (i_278_ == 1) {
					...
					if (i_276_ == 0)
						...
						anIntArrayArrayArray149[i_276_][i_275_][i_277_] = (anIntArrayArrayArray149[i_276_
								- 1][i_275_][i_277_] - i_279_ * 8);
						break;
					}
					break;
				}
				if (i_278_ <= 49) {
					aByteArrayArrayArray155[i_276_][i_275_][i_277_] = class50_sub1_sub2.readSignedByte();
