...
public class Class32_Sub1 extends Class32 implements Runnable {
		...
		try {
			...
			if (anInt1362 == 0 && i >= 6) {
				...
				for (Class50_Sub1_Sub3 class50_sub1_sub3 = (Class50_Sub1_Sub3) aClass6_1374
						.first(); class50_sub1_sub3 != null; class50_sub1_sub3 = (Class50_Sub1_Sub3) aClass6_1374
								.next()) {
				...
				if (anInt1362 + anInt1361 >= abyte0.length && aClass50_Sub1_Sub3_1372 != null) {
					if (aClient1373.aClass23Array1228[0] != null)
						aClient1373.aClass23Array1228[aClass50_Sub1_Sub3_1372.anInt1467 + 1]
								.write(aClass50_Sub1_Sub3_1372.anInt1468, abyte0);
	...
	public void method327(int i, int j, byte byte0, int k) {
		...
		if (anIntArrayArray1377[j][k] == 0)
			return;
		byte abyte0[] = aClient1373.aClass23Array1228[j + 1].read(k);
	...
	public void method329(int i, int j) {
		...
		synchronized (aClass9_1369) {
			for (Class50_Sub1_Sub3 class50_sub1_sub3 = (Class50_Sub1_Sub3) aClass9_1369
					.first(); class50_sub1_sub3 != null; class50_sub1_sub3 = (Class50_Sub1_Sub3) aClass9_1369.next())
			...
			while (aBoolean1339) {
				...
				if (!flag) {
					for (Class50_Sub1_Sub3 class50_sub1_sub3_1 = (Class50_Sub1_Sub3) aClass6_1374
							.first(); class50_sub1_sub3_1 != null; class50_sub1_sub3_1 = (Class50_Sub1_Sub3) aClass6_1374
									.next()) {
						flag = true;
	...
	public void method331(int i) {
		...
		if (i != 0)
			return;
		for (Class50_Sub1_Sub3 class50_sub1_sub3 = (Class50_Sub1_Sub3) aClass6_1374
				.first(); class50_sub1_sub3 != null; class50_sub1_sub3 = (Class50_Sub1_Sub3) aClass6_1374.next())
			if (class50_sub1_sub3.aBoolean1471)
				anInt1342++;
			else
				anInt1343++;
		...
		while (class50_sub1_sub3 != null) {
			...
			if (aClient1373.aClass23Array1228[0] != null)
				abyte0 = aClient1373.aClass23Array1228[class50_sub1_sub3.anInt1467 + 1]
						.read(class50_sub1_sub3.anInt1468);
