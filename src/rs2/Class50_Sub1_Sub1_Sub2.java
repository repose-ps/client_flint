...
public class Class50_Sub1_Sub1_Sub2 extends Class50_Sub1_Sub1 {
		...
		for (int i1 = 0; i1 < s.length(); i1++) {
			...
			if (c != ' ')
				method481(aByteArrayArray1500[c], k + anIntArray1503[c],
						i + anIntArray1504[c] + (int) (Math.sin((double) i1 / 2D + (double) j / 5D) * 5D),
						anIntArray1501[c], anIntArray1502[c], l);
			k += anIntArray1505[c];
		}
	...
	public void method476(int i, int j, byte byte0, String s, int k, int l) {
		...
		for (int j1 = 0; j1 < s.length(); j1++) {
			char c = s.charAt(j1);
			if (c != ' ')
				method481(aByteArrayArray1500[c],
						k + anIntArray1503[c] + (int) (Math.sin((double) j1 / 5D + (double) l / 5D) * 5D),
						i + anIntArray1504[c] + (int) (Math.sin((double) j1 / 3D + (double) l / 5D) * 5D),
						anIntArray1501[c], anIntArray1502[c], j);
			k += anIntArray1505[c];
		}
	...
	public void method477(int i, String s, int j, int k, int l, int i1, int j1) {
		...
		for (int l1 = 0; l1 < s.length(); l1++) {
			...
			if (c != ' ')
				method481(aByteArrayArray1500[c], k + anIntArray1503[c],
						l + anIntArray1504[c] + (int) (Math.sin((double) l1 / 1.5D + (double) j1) * d),
						anIntArray1501[c], anIntArray1502[c], j);
			k += anIntArray1505[c];
		}
	...
	public void method479(boolean flag, int i, int j, int k, int l, String s, int i1) {
		...
		for (int k1 = 0; k1 < s.length(); k1++)
			if (s.charAt(k1) == '@' && k1 + 4 < s.length() && s.charAt(k1 + 4) == '@') {
				...
				if (c != ' ') {
					if (flag)
						method483(j + anIntArray1503[c] + 1, true, 0, aByteArrayArray1500[c], l + anIntArray1504[c] + 1,
								anIntArray1502[c], anIntArray1501[c], 192);
