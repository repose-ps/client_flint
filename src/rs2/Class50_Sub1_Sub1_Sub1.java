...
public class Class50_Sub1_Sub1_Sub1 extends Class50_Sub1_Sub1 {
	...
	public void method467(Class50_Sub1_Sub1_Sub3 class50_sub1_sub1_sub3, int i, int j, int k) {
		...
		if (k1 <= 0 || j1 <= 0) {
			...
			method468(l, l1, anIntArray1489, k1, Class50_Sub1_Sub1.anIntArray1424,
					class50_sub1_sub1_sub3.aByteArray1516, 40303, j1, i1, 0, i2);
			return;
		}
	}

	public void method468(int i, int j, int ai[], int k, int ai1[], byte abyte0[], int l, int i1, int j1, int k1,
			int l1) {
		int i2 = -(k >> 2);
		if (l != 40303)
