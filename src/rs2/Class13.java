...
public class Class13 {
	...
	public static Class13 method198(int i, Buffer class50_sub1_sub2, int j, int k) {
			...
			for (int i2 = 0; i2 < 20; i2++) {
				...
				if (j3 == 1) {
					...
					if (s1.length() > 0) {
						...
						class13.aClass50_Sub1_Sub1_Sub1Array265[i2] = method194(Integer.parseInt(s1.substring(l4 + 1)),
		...
		if (class13.anInt236 == 5) {
			...
			if (s.length() > 0) {
				...
				class13.aClass50_Sub1_Sub1_Sub1_212 = method194(Integer.parseInt(s.substring(l3 + 1)),
						s.substring(0, l3), 373);
			}
			s = class50_sub1_sub2.readString();
			if (s.length() > 0) {
				int i4 = s.lastIndexOf(",");
				class13.aClass50_Sub1_Sub1_Sub1_245 = method194(Integer.parseInt(s.substring(i4 + 1)),
	...
	public static void method199(int i, Class50_Sub1_Sub1_Sub2 aclass50_sub1_sub1_sub2[], Archive class2,
			Archive class2_1) {
