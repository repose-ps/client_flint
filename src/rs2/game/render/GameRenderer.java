 ...
 *
 * <p>The renderer does not own world, protocol, interface, or chat state. Those
...
public final class GameRenderer {
    ...
    /** Creates an empty renderer; buffers are allocated lazily after resource loading. */
    public GameRenderer() {
    }
    ...
    /** Returns the dynamic viewport buffer, or {@code null} before game-screen initialization.
    ...
    /** Returns the minimap buffer, or {@code null} before game-screen initialization.
    ...
    /** Returns the sidebar buffer, or {@code null} before game-screen initialization.
    ...
    /** Returns the chatbox buffer, or {@code null} before game-screen initialization.
    ...
    /** Requests every fixed UI panel without synthesizing a game-screen keepalive event. */
    ...
    public static final class SceneFrame {
        ...
        /** Outgoing revision-377 packet buffer used by render-plane selection/projectiles. */
     ...
     * @param lowMemory whether low-memory rendering disables texture animation
     */
    ...
    /** Returns a cleared graphics context for the current off-screen presentation surface.
