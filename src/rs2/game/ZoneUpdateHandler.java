    ...
    public void decode(Buffer buffer, int updateType, int currentPlane, int currentCycle, int localPlayerServerIndex,
        ...
        if (updateType == ATTACH_OBJECT_TO_PLAYER) {
            ...
            if (player != null) {
                ...
                if (model != null) {
                    world.schedulePendingSpawn(currentPlane, tileX, tileY, sceneLayer, -1, 0, 0,
                            startDelay + 1, endDelay + 1);
        ...
        if (updateType == ANIMATE_GAME_OBJECT) {
            ...
            if (tileX >= 0 && tileY >= 0 && tileX < 103 && tileY < 103) {
                ...
                if (sceneLayer == 1) {
                    ...
                    if (decoration != null) {
                        decoration.renderable = new DynamicObject(decoration.uid >> 14 & 0x7fff, 4, 0,
        ...
        if (updateType == ADD_PROJECTILE) {
            ...
            if (sourceTileX >= 0 && sourceTileY >= 0 && sourceTileX < 104 && sourceTileY < 104
                    && destinationTileX >= 0 && destinationTileY >= 0 && destinationTileX < 104
                    && destinationTileY < 104 && spotAnimationId != 65535) {
                ...
                Projectile projectile = new Projectile(spotAnimationId, currentPlane, sourceX, sourceY,
                        world.getTileHeight(sourceX, sourceY, currentPlane) - sourceHeight,
                        startDelay + currentCycle, endDelay + currentCycle, slope, startHeight, targetIndex, endHeight);
