/**
 * Contains high-level client runtime systems that coordinate game-state
 * updates and presentation state.
 *
 * <p>
 ...
 * server and cache state rather than authoritative game logic. Logged-in
